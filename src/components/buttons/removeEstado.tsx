...
const RemoveEstadoButton = ({ array }: IRemove) => {
          ...
          >
            <Dialog.Close asChild>
              <button
                ...
                onClick={async () => {
                  try {
                    await removeEstado(id).then(() => {
                      const filteredArray = estados!.filter(
                        (old) => old.id !== id
                      );
                      console.log(filteredArray);
                      setEstados([...filteredArray]);
                    });
...
export default RemoveEstadoButton;
